// $Id: kwresearch.js,v 1.1.2.12 2011/01/05 20:42:59 tomdude48 Exp $
...
*/
var kwresearch_keyword_data = new Array();

Drupal.behaviors.kwresearch_init = function (context) {
  kwresearch_init();
}

var kwresearch_init = function () {
...
//alert("vid=" + vid);
	if (report_vocabs[vid] > 0 && ($('.kwresearch-refresh-link-' + vid).length == 0)) {
      h = '<a href="#" class="kwresearch-refresh-link-' + vid + '" onclick="kwresearch_refresh_tax_report(\'' + vid + '\'); return false;" title="refresh report">';
...
var kwresearch_get_keyword_list = function(type) {
  var value = '';
...
var kwresearch_contentanalysis_analysis_success = function(aid, data) {	
  kwresearch_init();	
}

var kwresearch_in_array = function(needle, haystack) {
...
var kwresearch_process_keywords = function() {
...
var kwresearch_get_buttons = function(keyword) {
    str = '<div class="kwresearch_actions">';
    title = Drupal.t('Keyword report');
    str += '<a href="#" onclick="kwresearch_launch_report(\'' + keyword + '\'); return false;" title="' + title + '" class="kwresearch-tool-button">';
...
var kwresearch_get_toggle_button = function(keyword, type) {
  var str = '';
  ...
  if (type == 'sitekw') {  
    if (Drupal.settings.kwresearch.enable_site_keyword_tool) { // TODO add admin permission logic
      ...
      str += '<div onmouseover="kwresearch_display_tool_site_keyword_menu(this, 1);" onmouseout="kwresearch_display_tool_site_keyword_menu(this, 0);" class="kwresearch-tool-group kwresearch-tool-button kwresearch-tool-button-site-keyword-' + keywordns + '">'
      str += '<a href="#" onclick="kwresearch_toggle_sitekw_keyword(\'' + keyword + '\', ' + add + ', \'' + keywordns + '\'); return false;" title="' + title + '" >';
      str += '<img src="' + Drupal.settings.kwresearch.module_path + '/icons/site_keyword_' + img + '.png" title="' + title + '" />';
      str += '</a>';      

      str += '<ul class="kwresearch-tool-menu kwresearch-tool-menu-site-priority-' + keyword + '" style="display: none;">';
      ...
      for ( var i in op ) {
        ...
        str += '<li class="' + active + '"><a href="#" onclick="kwresearch_toggle_sitekw_keyword(\'' + keyword + '\', ' + add + ', \'' + keywordns + '\', ' + i + '); return false;">' + op[i] + '</a></li>';
      }
      str += '</ul>';  
      str += '</div>';      
    }
  ...
  if (type == 'siteops') {
	...
	if ((Drupal.settings.kwresearch.form != null) && (Drupal.settings.kwresearch.form.substr(0, 5) == 'admin')) {
	    ...
	    str += '<a href="' + link + '" onclick="kwresearch_edit_keyword(' + d[keyword]['kid'] + '); return false;" title="' + title + '" class="kwresearch-tool-button">';
    ...
    if ((Drupal.settings.kwresearch.form != null) && (Drupal.settings.kwresearch.form == 'admin_keyword_list') && !(d[keyword]['page_count'] > 0)) {
	    ...
	    str += '<a href="#" onclick="kwresearch_delete_keyword(\'' + escape(keyword) + '\', ' + d[keyword]['kid'] + '); return false;" title="' + title + '" class="kwresearch-tool-button">';
  ...
  if (type == 'pagekw') {  
    if (Drupal.settings.kwresearch.enable_page_keyword_tool) { // TODO add admin permission logic
      ...
      str += '</a>';
      */      
      str += '<div onmouseover="kwresearch_display_tool_page_keyword_menu(this, 1);" onmouseout="kwresearch_display_tool_page_keyword_menu(this, 0);" class="kwresearch-tool-group kwresearch-tool-button kwresearch-tool-button-page-keyword-' + keywordns + '">'
      str += '<a href="#" onclick="kwresearch_toggle_pagekw_keyword(\'' + keyword + '\', ' + add + ', \'' + keywordns + '\'); return false;" title="' + title + '" >';
      str += '<img src="' + Drupal.settings.kwresearch.module_path + '/icons/page_keyword_' + img + '.png" title="' + title + '" />';
      str += '</a>';      
      ...
      for ( var i in op ) {
        ...
        str += '<li class="' + active + '"><a href="#" onclick="kwresearch_toggle_pagekw_keyword(\'' + keyword + '\', ' + add + ', \'' + keywordns + '\', ' + i + '); return false;">' + op[i] + '</a></li>';
      }
      str += '</ul>';    
      str += '</div>';      
    ...
    if (Drupal.settings.kwresearch.keyword_tag_vocabulary 
      ...
      keyword
      str += '<a href="#" onclick="kwresearch_toggle_vocab_keyword(\'' + keyword + '\', ' + add + ', this); return false;" title="' + title + '" class="kwresearch-tool-button">';
    ...
    if ($('#edit-morelikethis-terms').size() > 0) {
      ...
      str += '<a href="#" onclick="kwresearch_toggle_mlt_keyword(\'' + keyword + '\', ' + add + ', this); return false;" title="' + title + '" class="kwresearch-tool-button">';
    ...
    if ($('#edit-nodewords-keywords-value').size() > 0) {
      ...
      str += '<a href="#" onclick="kwresearch_toggle_meta_keyword(\'' + keyword + '\', ' + add + ', this); return false;" title="' + title + '" class="kwresearch-tool-button">';
...
var kwresearch_display_tool_site_keyword_menu = function(theDiv, state) {
  if (state == 1) {
...
var kwresearch_display_tool_page_keyword_menu = function(theDiv, state) {
  if (state == 1) {
    $(theDiv).children('ul').show();
  }
  else {
...
var kwresearch_launch_report = function(keyword) {
  ...
  contentanalysis_show_analyzer_tab(document.getElementById('contentanalysis-analyzer-tab-kwresearch'));
  kwresearch_analyze();
  return false;
}

var kwresearch_toggle_sitekw_keyword = function(keyword, add, keywordns, priority) {
  var data = { 
...
var kwresearch_edit_keyword = function(kid) {
...
var kwresearch_delete_keyword = function(keyword, kid) {
...
var kwresearch_toggle_pagekw_keyword = function(keyword, add, keywordns, priority) {
  
  // update sync vocabulary
  v = $('#edit-taxonomy-tags-' + Drupal.settings.kwresearch.keyword_sync_vocabulary).val();
  if (add) {    
    nv = v + (v ? ', ' : '') + keyword;    
  }
  else {
  ...
  $('#edit-taxonomy-tags-' + Drupal.settings.kwresearch.keyword_sync_vocabulary).val(nv);
...
var kwresearch_toggle_vocab_keyword = function(keyword, add, theLink) {
  v = $('#edit-taxonomy-tags-' + Drupal.settings.kwresearch.keyword_tag_vocabulary).val();
  if (add) {    
    nv = v + (v ? ', ' : '') + keyword;    
  }
  else {
  ...
  $('#edit-taxonomy-tags-' + Drupal.settings.kwresearch.keyword_tag_vocabulary).val(nv);
  $(theLink).replaceWith(kwresearch_get_toggle_button(keyword, 'vocab'));
  return false;
}

var kwresearch_toggle_mlt_keyword = function(keyword, add, theLink) {
...
var kwresearch_toggle_meta_keyword = function(keyword, add, theLink) {
  v = $('#edit-nodewords-keywords-value').val();
  if (add) {    
    nv = v + (v ? ', ' : '') + keyword;    
  }
  else {
  ...
  $('#edit-nodewords-keywords-value').val(nv);
  $(theLink).replaceWith(kwresearch_get_toggle_button(keyword, 'meta_keywords'));
  return false;
}

var kwresearch_remove_phrase_from_list = function(keyword, list) {
  kws0 = list.split(',');  
  kws1 = new Array();
  j = 0;
  for(var i in kws0) {    
...
var kwresearch_analyze = function() {
...
var kwresearch_refresh_tax_report = function(vid) {
